...
> **Wersja skorygowana po audycie źródłowym FS-ASM v6.0.**  
> Sekcja v6.0 oraz wnioski przekrojowe zostały zaktualizowane po rozpakowaniu i analizie pełnego pakietu `FS-ASM_v6.0.zip`. Usunięto wcześniejsze hipotezy rekonstrukcyjne i zastąpiono je ustaleniami wynikającymi z rzeczywistych plików v6.0, w szczególności changelogu oraz migration guide.
...
System próbuje aktywnie ograniczyć błędy poznawcze modelu.
