...
Before designing or changing the FS-ASM workflow, read:

1. [`ORIGIN_AND_CURRENT_UNDERSTANDING.md`](ORIGIN_AND_CURRENT_UNDERSTANDING.md)
2. [`docs/FSASM_SOURCE_AUDIT.md`](docs/FSASM_SOURCE_AUDIT.md)
3. [`docs/FSASM_SOURCE_INVENTORY.md`](docs/FSASM_SOURCE_INVENTORY.md)

Historical FS-ASM specifications are research inputs, not executable
